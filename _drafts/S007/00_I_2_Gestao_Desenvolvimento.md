# Gestão de Desenvolvimento v0.1
...
|--------------|-------------------------|
| **Gestão de Desenvolvimento** | Sistema que orquestra o ciclo de vida do conhecimento: captura → organização → execução → publicação |
...
│                           PROBLEMA CENTRAL                                  │
│                                                                             │
│  "Como gerenciar o ciclo de vida do conhecimento emergente em conversas     │
│   LLM, desde a captura até a publicação, sem perder contexto?"              │
│                                                                             │
└──────────────────────────────────┬──────────────────────────────────────────┘
                                   │
                                   ▼
...
│  ├─────────────────────┤  ├─────────────────────┤  ├─────────────────────┤  │
│  │ Forks se perdem     │  │ Itens sem estrutura │  │ Sem processo claro  │  │
...
│  └─────────────────────────────────────────────────────────────────────┘    │
│                                                                             │
│  Dois subsistemas especializados, um orquestrador.                          │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
> **Gestão de Desenvolvimento é o Meta Sistema que orquestra o ciclo de vida do conhecimento emergente via dois subsistemas:**
>
...
│  │ → Contexto preservado     │       │ → Progresso visível       │          │
│  └───────────────────────────┘       └───────────────────────────┘          │
│                    │                           ▲                            │
│                    │        promover()         │                            │
│                    └───────────────────────────┘                            │
│                                                                             │
│  ORQUESTRAÇÃO: Gestão de Desenvolvimento decide QUANDO promover             │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
**Gestão de Desenvolvimento** é o Meta Sistema que:
...
| Gestão de Desenvolvimento É | Gestão de Desenvolvimento NÃO É |
|-----------------------------|--------------------------------|
...
│  Métodos                                                                    │
│  ────────                                                                   │
│  + promover(item: BacklogItem, codigo: String): Sprint                      │
...
│                        promover()                               │
├─────────────────────────────────────────────────────────────────┤
│  Input: item (BacklogItem), codigo (String ex: "S008")          │
...
│                                                                             │
│  ┌──────────┐        ┌──────────┐        ┌──────────┐        ┌──────────┐   │
│  │ Fork     │        │ Backlog  │        │  Sprint  │        │  docs/   │   │
│  │ detectado│──────► │ Item     │──────► │  Ativa   │──────► │          │   │
