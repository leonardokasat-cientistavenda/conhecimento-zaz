...
mongodb_ref: "sprint_sessions.codigo = 'S-PANTHEON-003'"
items_selecionados:
  - BKL-PANTHEON-001
  - BKL-PANTHEON-008
  - BKL-PANTHEON-014
...
| BKL-GH-008 | Testes E2E GitHub | 2h | 🔴 Alta |
| **Total** | | **24.5h** | |
...
### T09: Testes E2E GitHub (conhecimento-zaz)
**BKL:** BKL-GH-008 | **Esforço:** 2h | **Status:** 🔄 Em Andamento

Plano de testes detalhado em: `pantheon/infra-bot/TESTES_E2E_GITHUB_conhecimento-zaz.md`

| Task | Operação | Status |
|------|----------|--------|
| T01 | create | ⬜ Pendente |
| T02 | get | ⬜ Pendente |
| T03 | replace | ⬜ Pendente |
| T04 | patch | ⬜ Pendente |
| T05 | list | ⬜ Pendente |
| T06 | delete | ⬜ Pendente |
| T07 | push | ⬜ Pendente |
| **T08** | **Limpeza: deletar docs/04_S/S-PANTHEON-003.md** | ⬜ Pendente |

> **T08 (Limpeza)**: Arquivo movido para `_sprints/`. Usar operação `delete` para remover o arquivo obsoleto em `docs/04_S/S-PANTHEON-003.md`. Valida operação delete E limpa repositório.
...
| Protocolo Agent Loop | docs/04_S/PROTOCOLO_AGENT_LOOP.md |
| Plano Testes E2E | pantheon/infra-bot/TESTES_E2E_GITHUB_conhecimento-zaz.md |
...
| 2.1 | 2026-01-06 | **Mover para _sprints/**: Adicionar T09 (Testes E2E) com task de limpeza. Referência MongoDB. |
